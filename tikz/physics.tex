  ...
  \centerline{
    ...
    \resizebox{7cm}{!}{
      \begin{tikzpicture}[
          ...
          trans/.style={thick,<->,shorten >=2pt,shorten <=2pt,>=stealth}, % stealth make better looking arrows
          classical/.style={thin,double,<->,shorten >=4pt,shorten <=4pt,>=stealth} % shorten the length of the arrow at specified end
        ]
